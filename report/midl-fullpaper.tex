...
\node[aug,  right=of input]    (hed)      {HED\\Jitter};
\node[aug,  right=of hed]      (mac)      {Macenko\\Aug.};
...
\begin{scope}[on background layer]
  \node[draw=orange!60, dashed, rounded corners, fill=orange!5,
        fit=(hed)(mac)(spatial), inner sep=5pt,
...
Jitter (additive noise in HED stain-concentration space) was also tested as an alternative to Macenko but did not yield positive results.
