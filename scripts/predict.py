...
from challenge import builder, compute, preprocessing, stain
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("checkpoint", type=Path, help="Directory where model checkpoints are saved.")
    parser.add_argument("--test-path", type=Path, default="data/test.h5", help="Path to training .h5 file.")
    parser.add_argument("--val-path", type=Path, default="data/val.h5", help="Path to training .h5 file.")
    parser.add_argument(
        "--batch-size",
        type=int,
        default=512,
