...
def kimiaNet(pretrained=False, freeze_backbone=False, num_classes=2, path='weights/KimiaNetPyTorchWeights.pth'):
    ...
    if pretrained:
        ...
        model_final.load_state_dict(state_dict, strict=True)
